  ...
  mainwindow {
    ...
    canvas {
      ...
      circle {
        ...
        square fill: :green, width: 60, rotation: 10, movable: {connector: :movable}
    ...
    menubar {
      menu {
        title tr('&Move')
        action text: tr('Green may &Move'), checkable: true, connector: :movable
        quiter
      }
    }
  }
