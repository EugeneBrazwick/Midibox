...
static VALUE
cGraphicsView_scene_assign(VALUE v_self, VALUE v_scene)
{
  track2("cGraphicsView_scene_assign(self=%s,scene=%s)", v_self, v_scene);
...
init_graphicsview(VALUE mQt, VALUE cWidget)
{
  ...
  rb_define_method(cGraphicsView, "scene=", RUBY_METHOD_FUNC(cGraphicsView_scene_assign), 1);
} // init_graphicsview
} // namespace R_Qt 
